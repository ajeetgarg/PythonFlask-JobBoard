...
def jobs():
    ...
    'job.salary, employer.id as employer_id, employer.name as employer_name FROM '\
...
def job(job_id):
    ...
    'job.salary, employer.id as employer_id, employer.name as employer_name FROM '\
    'job JOIN employer ON employer.id = job.employer_id WHERE job.id = ' \
    '?', [job_id], single=True)
...
def employer(employer_id):
    ...
    'review JOIN employer ON employer.id = review.employer_id WHERE '\
